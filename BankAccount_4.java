    ...
    private static void createCustomer() {
        ...
        while (!check.equalsIgnoreCase("NO")) {
            ...
            if (bankAccount3 == null) {
                ...
                account12s.add(obj);
                System.out.print("CUSTOMER ACCOUNT HAS BEEN CREATED.\nDO YOU WANT TO ADD MORE TYPE[YES] OR " +
...
class CustomerAccount implements Serializable {
    ...
    public static void checkBankBal() throws InputMismatchException{
        ...
        if (customerAccount != null) {
            ...
            System.out.println("\nINVALID ACCOUNT NUMBER/ HAVEN'T CREATE AN BANK ACCOUNT,TRY AGAIN");
            BankAccount_4.printCustomerMenu();
        }
    }
    ...
    public static void transaction() throws InputMismatchException{
        ...
        if (customerAccount1 != null) {
                    ...
                    if (customerAccount1.getAccNum() != customerAccount2.getAccNum()) {
                        ...
                        if (!(transferAmount <= 0)) {
                            ...
                            if (!(customerAccount1.getAccBal() < 0)) {
                                ...
                                customerAccount1.deposit(transferAmount);
                                customerAccount2.withdraw(transferAmount);
                                System.err.println("\nYOUR ACCOUNT BALANCE IS FALLING BELOW $0,TRY AGAIN.");
                                transaction();
                            }
                        } else {
            ...
            System.out.println("INVALID ACCOUNT NUMBER/ HAVEN'T CREATE AN BANK ACCOUNT,TRY AGAIN");
            BankAccount_4.printCustomerMenu();
        }
    }
